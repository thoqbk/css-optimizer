# css-optimizer
[css-optimizer](https://github.com/thoqbk/css-optimizer) is a tool that helps you to remove `un-used css rules` basing on sample html files of your website
...
//Step 02. Sampling your website by downloading web pages or use http urls
optimizer.addHtmlFile("about-us.htm");
optimizer.addHtmlFile("amazon.com.htm");
optimizer.addHtmlFile("blog.htm");
optimizer.addHtmlFile("http://yourwebsite.com/product/ipad");
